  ...
  return (
    <>
      {allIds.map((id) => {
        ...
        const sittingOffset = (ch.state === CharacterState.TYPE || ch.state === CharacterState.SIT) ? 6 : 0;
        ...
        if (isWaiting) {
          dotColor = 'var(--pixel-status-permission, #cca700)';
        } else if (isActive) {
          dotColor = 'var(--pixel-status-active, #3794ff)';
        }
