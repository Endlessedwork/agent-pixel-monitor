      ...
      <div
        ...
        style={{
          ...
          background: isSelected
            ? 'var(--pixel-selected-bg, rgba(255,255,255,0.04))'
            : undefined,
        }}
      >
        <span style={{ display: 'inline-flex', alignItems: 'center', gap: 0 }}>
          ...
          <button
            onClick={() => wsClient.send({ type: 'closeAgent', id })}
            style={{
              borderRadius: 0,
              padding: '6px 8px',
              fontSize: '26px',
            ...
            {tools.map((tool) => (
              <div key={tool.toolId}>
                ...
                {subs[tool.toolId] && subs[tool.toolId].length > 0 && (
                  <div
                    style={{
                      borderLeft: '2px solid var(--pixel-border-light, rgba(255,255,255,0.12))',
                      marginLeft: 3,
                      paddingLeft: 8,
                      marginTop: 1,
                      display: 'flex',
              ...
              >
                <span
                  style={{
                    ...
                    height: 6,
                    borderRadius: '50%',
                    background: 'var(--pixel-status-permission, #cca700)',
                    display: 'inline-block',
                    flexShrink: 0,
                  }}
                />
  ...
  return (
    <div
      style={{
        ...
        width: '100%',
        height: '100%',
        background: 'var(--pixel-editor-bg, #1e1e2e)',
        zIndex: DEBUG_Z,
        overflow: 'auto',
      }}
    >
