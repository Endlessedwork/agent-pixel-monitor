...
// Inline bubble data to avoid JSON import issues
const bubblePermissionData: BubbleSpriteJson = {
...
const bubbleWaitingData: BubbleSpriteJson = {
...
// ================================================================
// Loaded character sprites (from PNG assets via HTTP API)
// ================================================================
